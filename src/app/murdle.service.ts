...
getMurdleById(id: string) {
    this.currentMurdle = this.DATA.cases.find(murdle => murdle.id == id)
...
changeActiveMurdle(id: string) {
    console.log("Current murdle ID")
    console.log(id)
    this.currentMurdle = this.getMurdleById(id);
}
